...
export class OrOperation extends Operation {
    ...
    query(node1: Array<number>, node2: Array<number>): Array<number> {
        ...
        else if (node2_index < node2.length){

            let slice : Array<number> = node2.slice(node2_index, node2.length)
